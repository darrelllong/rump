...
pointer width is not 64, so a 32-bit build fails with a diagnostic naming the
reason instead of compiling and misindexing at run time on an operand large
