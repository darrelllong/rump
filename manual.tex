...
Three regimes, each measured against the kernel it displaces: below 8 limbs
...
to 256 limbs a Karatsuba squaring, whose three sub-products are themselves
squares, since $z_1 = (a_0+a_1)^2 - a_0^2 - a_1^2$; and at 256 limbs and
above the Toom kernels win outright and it hands back. End to end the
saving is 15\% at 8 limbs, 36\% at 16, 27\% at 64, and parity outside the
specialized range.
