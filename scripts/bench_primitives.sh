...
echo "with a 95% confidence interval on it (\`±95% CI\`, as a percent of the"
echo "mean — 1.96 standard errors of the full readings sample, which are"
echo "independent draws). The ns/op order statistics are the extrema of each"
