...
# This file was *autogenerated* from the file scripts/check_symbol_vectors.sage
from sage.all_cmdline import *   # import sage library

_sage_const_0 = Integer(0); _sage_const_16 = Integer(16); _sage_const_1 = Integer(1)# Recomputes every Jacobi and Kronecker test vector in src/number_theory.rs
...
for a, n, expected in vectors("JACOBI_VECTORS"):
    got = jacobi_symbol(Integer(a, _sage_const_16 ), Integer(n, _sage_const_16 ))
    if got != Integer(expected):
        bad += _sage_const_1 
        print("jacobi", a, n, "expected", expected, "sage", got)
for a, n, expected in vectors("KRONECKER_VECTORS"):
    got = kronecker_symbol(Integer(a, _sage_const_16 ), Integer(n, _sage_const_16 ))
    if got != Integer(expected):
        bad += _sage_const_1 
