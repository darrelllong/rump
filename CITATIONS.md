...
| Dickman's function | `dickman_rho` | Dickman, *On the frequency of numbers containing prime factors of a certain relative magnitude*, Ark. Mat. Astr. Fys. 22A (1930); numerical treatment after van de Lune & Wattel, *On the numerical solution of a differential-difference equation arising in analytic number theory*, Math. Comp. 23 (1969), 417–421 — the Volterra (integral) form, trapezoid-stepped. |
...
| Log-gamma | `ln_gamma` | Lanczos, *A precision approximation of the gamma function*, J. SIAM Numer. Anal. B 1 (1964), 86–96, with the `g = 7` nine-term coefficients; the reflection formula below one half. |
| Semismoothness probability | `semismooth_probability` | Bach & Peralta, *Asymptotic semismoothness probabilities*, Math. Comp. 65 (1996), 1701–1715; the two-large-prime term after Lambert, *Computational aspects of discrete logarithms*, PhD thesis, University of Waterloo, 1996; Dickman's ρ as the smooth part. Midpoint-rule integration. |
| Short vectors under an integral form | `short_vectors_form` | Fincke & Pohst, *Improved methods for calculating vectors of short length in a lattice, including a complexity analysis*, Math. Comp. 44 (1985), 463–471; Schnorr & Euchner, *Lattice basis reduction: improved practical algorithms and solving subset sum problems*, Math. Programming 66 (1994), 181–199 (the enumeration with the zig-zag order). Floating-point Gram–Schmidt with every admitted vector's norm recomputed exactly. |
