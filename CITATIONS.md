...
| Structured elimination with composition replay | `filter_merge`, `FilteredMatrix` | Structured Gaussian elimination as NFS filtering practice; modern treatment in Bouillaguet & Zimmermann, *Parallel Structured Gaussian Elimination for the Number Field Sieve*, J. Math. Cryptol. (2021); replay by carried row compositions rather than a history log is this crate's choice, proven by the expansion identity in tests. |
